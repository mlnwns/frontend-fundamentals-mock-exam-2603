...
import { EQUIPMENT_LABELS, HOUR_LABELS, TOTAL_MINUTES } from 'shared/constants/reservation';
...
import { timeToTimelineMinutes } from 'shared/utils/reservation';

type ReservationTimelineSectionProps = {
  rooms: RoomSummary[];
